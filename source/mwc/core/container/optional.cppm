...
export namespace mwc {
  ...
  struct optional_st {
    ...
    [[nodiscard]] constexpr operator bool(this auto&& a_this);
  ...
  constexpr optional_st<tp>::optional_st() : m_data {},
                                             m_void {true} {}
  template <typename tp>
  constexpr optional_st<tp>::optional_st(const tp& a_data)
  : m_data {a_data},
    m_void {false} {}
  template <typename tp>
  constexpr optional_st<tp>::operator bool(this auto&& a_this) {
