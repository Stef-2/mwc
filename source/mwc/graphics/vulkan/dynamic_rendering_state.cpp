  ...
  namespace graphics {
    namespace vulkan {
      ...
      auto dynamic_rendering_state_ct::bind(const vk::raii::CommandBuffer& a_command_buffer) const -> void {
        ...
        a_command_buffer.setDepthTestEnableEXT(m_configuration.m_depth_test_enable);
        a_command_buffer.setDepthBoundsTestEnable(m_configuration.m_depth_bounds_test_enable);
        a_command_buffer.setDepthClampEnableEXT(m_configuration.m_depth_clamp_enable);
        a_command_buffer.setDepthWriteEnableEXT(m_configuration.m_depth_write_enable);
        ...
        a_command_buffer.setRasterizerDiscardEnableEXT(m_configuration.m_rasterizer_discard_enable);
        ...
        a_command_buffer.setAlphaToCoverageEnableEXT(m_configuration.m_alpha_to_coverage_enable);
        a_command_buffer.setAlphaToOneEnableEXT(m_configuration.m_alpha_to_one_enable);
        a_command_buffer.setDepthBiasEnable(m_configuration.m_depth_bias_enable);
