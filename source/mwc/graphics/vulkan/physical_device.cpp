  ...
  namespace graphics {
    namespace vulkan {
      ...
      : handle_ct {std::invoke([&a_instance] {
          ...
          const auto physical_devices = a_instance.unique_handle().enumeratePhysicalDevices().value;
        ...
        m_properties {std::invoke([this]([[maybe_unused]] this auto&& a_this) noexcept -> properties_st {
          ...
          return properties_st {unique_handle().getProperties2<decltype(default_properties_pack)...>(),
                                unique_handle().getMemoryProperties2<decltype(memory_properties_pack)...>(),
                                unique_handle().getQueueFamilyProperties2<properties_st::queue_family_chain_t>()};
        })},
        m_features {std::invoke([this]([[maybe_unused]] this auto&& a_this) -> features_st {
          ...
          return features_st {unique_handle().getFeatures2<decltype(default_features_pack)...>()};
        })},
