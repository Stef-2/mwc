  ...
  namespace graphics {
    namespace vulkan {
      class pipeline_layout_ct : public handle_ct<vk::raii::PipelineLayout> {
        public:
        using descriptor_count_t = uint16_t;
        ...
        [[nodiscard]] auto descriptor_count() const -> descriptor_count_t;
        [[nodiscard]] auto acquire_descriptor_index() -> descriptor_count_t;
        ...
        descriptor_count_t m_descriptor_index;
