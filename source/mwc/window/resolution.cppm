...
export namespace mwc {
  ...
  struct resolution_st {
    ...
    using aspect_ratio_t = float32_t;

    constexpr resolution_st();
    constexpr resolution_st(const extent_t a_width, const extent_t a_height);
    constexpr resolution_st(const resolution_et a_resolution);
    constexpr auto aspect_ratio() const -> aspect_ratio_t;
  ...
  constexpr auto resolution_st::aspect_ratio() const -> aspect_ratio_t {
    return static_cast<aspect_ratio_t>(m_width) / static_cast<aspect_ratio_t>(m_height);
  }
}